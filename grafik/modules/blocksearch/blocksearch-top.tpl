...
<div id="search_block_top">
	...
	<form method="get" action="{$link->getPageLink('search.php')}" id="searchbox">
        ...
        <label for="search_query_top"><!-- image on background --></label>
			...
			<input class="search_query" type="text" id="search_query_top" name="search_query" placeholder="Search Keyword..." value="{if isset($smarty.get.search_query)}{$smarty.get.search_query|htmlentities:$ENT_QUOTES:'utf-8'|stripslashes}{/if}" />
