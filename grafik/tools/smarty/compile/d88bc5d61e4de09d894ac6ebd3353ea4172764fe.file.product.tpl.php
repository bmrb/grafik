<?php /* Smarty version Smarty-3.0.7, created on 2012-10-11 18:49:50
         compiled from "/home/graf546/domains/grafikstock.com/public_html/grafik/themes/prestashop/product.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1197937363507706bedd7ee2-05213167%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'd88bc5d61e4de09d894ac6ebd3353ea4172764fe' => 
    array (
      0 => '/home/graf546/domains/grafikstock.com/public_html/grafik/themes/prestashop/product.tpl',
      1 => 1345704124,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1197937363507706bedd7ee2-05213167',
  'function' => 
  array (
  ),
...
if (!is_callable('smarty_function_math')) include '/home/graf546/domains/grafikstock.com/public_html/grafik/tools/smarty/plugins/function.math.php';
if (!is_callable('smarty_function_counter')) include '/home/graf546/domains/grafikstock.com/public_html/grafik/tools/smarty/plugins/function.counter.php';
?>
...
" />
    ...
    <b><span style="font-family:Arial, Helvetica, sans-serif; font-weight:bold; font-size:13px; color:#989898">&nbsp;&nbsp;<?php echo smarty_modifier_escape($_smarty_tpl->getVariable('product')->value->name,'htmlall','UTF-8');?>
</span></b>
    
		<?php if ($_smarty_tpl->getVariable('product')->value->description_short||count($_smarty_tpl->getVariable('packItems')->value)>0){?>
		<div id="short_description_block" style="font-family:Arial, Helvetica, sans-serif; font-weight:normal; font-size:12px; color:#989898;">
			<?php if ($_smarty_tpl->getVariable('product')->value->description_short){?>
				<div id="short_description_content" class="rte align_justify" style="font-family:Arial, Helvetica, sans-serif; font-weight:normal; font-size:12px; color:#989898;"><?php echo $_smarty_tpl->getVariable('product')->value->description_short;?>
</div>
			<?php }?>

            <div>
        <b><span style="font-family:Arial, Helvetica, sans-serif; font-weight:bold; font-size:13px; color:#989898;">Image ID:</b></span><span style="font-size:16px"><?php echo smarty_modifier_escape($_smarty_tpl->getVariable('product')->value->reference,'htmlall','UTF-8');?>
</span><br /><br />
       <b><span style="font-family:Arial, Helvetica, sans-serif; font-weight:bold; font-size:13px; color:#989898;">Requires Credits:</span></b> <span style="font-size:16px"><?php echo $_smarty_tpl->getVariable('tokens')->value;?>
</span><br /><br />
<!-- module productpagetags -->
<?php if (count($_smarty_tpl->getVariable('tags')->value)>0){?>
     <div id="productpage_tag" style="font-family:Arial, Helvetica, sans-serif; font-weight:bold; font-size:13px; color:#989898;"> Keywords:<br />
...
if ($_smarty_tpl->_count($_from) > 0){
 ...
 $_smarty_tpl->tpl_vars['name']->value = $_smarty_tpl->tpl_vars['tag']->key;
?>
        <a href="<?php echo $_smarty_tpl->getVariable('link')->value->getPageLink('search.php');?>
?tag=<?php echo urlencode($_smarty_tpl->tpl_vars['tag']->value);?>
" style="font-family:Arial, Helvetica, sans-serif; font-weight:normal; font-size:12px; color:#989898; text-decoration:none"><?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['tag']->value,'htmlall','UTF-8');?>
</a>,&nbsp;
        <?php }} ?>
        </div>
<?php }?>
...
"><?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['group_attribute']->value,'htmlall','UTF-8');?>
			...
			<p id="quantity_wanted_p"<?php if ((!$_smarty_tpl->getVariable('allow_oosp')->value&&$_smarty_tpl->getVariable('product')->value->quantity<=0)||$_smarty_tpl->getVariable('virtual')->value||!$_smarty_tpl->getVariable('product')->value->available_for_order||$_smarty_tpl->getVariable('PS_CATALOG_MODE')->value){?> style="display: none;"<?php }?>>
				...
				<input type="hidden" name="qty" id="quantity_wanted" class="text" value="<?php if (isset($_smarty_tpl->getVariable('quantityBackup',null,true,false)->value)){?><?php echo intval($_smarty_tpl->getVariable('quantityBackup')->value);?>
...
<div id="more_info_block" class="clear">
	<ul id="more_info_tabs" class="idTabs idTabsShort">
		<?php if ($_smarty_tpl->getVariable('product')->value->description){?><li><a id="more_info_tab_more_info" href="#idTab1"></a></li><?php }?>
		<?php if ($_smarty_tpl->getVariable('features')->value){?><li><a id="more_info_tab_data_sheet" href="#idTab2"></a></li><?php }?>
		<?php if ($_smarty_tpl->getVariable('attachments')->value){?><li><a id="more_info_tab_attachments" href="#idTab9"></a></li><?php }?>
		<?php if (isset($_smarty_tpl->getVariable('accessories',null,true,false)->value)&&$_smarty_tpl->getVariable('accessories')->value){?><li><a href="#idTab4"></a></li><?php }?>
		<?php echo $_smarty_tpl->getVariable('HOOK_PRODUCT_TAB')->value;?>

	</ul>
	<div id="more_info_sheets" class="sheets align_left">

		<!-- full description -->
		<div id="idTab1" class="rte" style="font-family:Arial, Helvetica, sans-serif; font-weight:normal; font-size:12px; color:#303235;">
        <br /><br /><br /><span style="color:#989898">
        This image is a vector illustration specifically designed for textile graphics.<br />
        This image will download as an .eps file and can be altered using a vector editor<br /> 
        ( e.g. Adobe Ilustrator) and scaled to any size in its original resolution</span>
<br /><br /><br /><br />
        </div>
	...
	<div style="border-top: solid 1px #e0e0e0;"><br />Similar Artworks</div><br /><br />
...
?>
<?php if ($_smarty_tpl->getVariable('smarty')->value['foreach']['categoryProduct']['index']==7){?>
    <?php break 1?>
<?php }?> 
			<li class="ajax_block_product" style="width:110px">
...
"><img src="<?php echo $_smarty_tpl->getVariable('link')->value->getImageLink($_smarty_tpl->tpl_vars['categoryProduct']->value['link_rewrite'],$_smarty_tpl->tpl_vars['categoryProduct']->value['id_image'],'home');?>
" height="110px" width="110px" alt="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['categoryProduct']->value['name']);?>
" /></a><br/>
				<a href="<?php echo $_smarty_tpl->getVariable('link')->value->getProductLink($_smarty_tpl->tpl_vars['categoryProduct']->value['id_product'],$_smarty_tpl->tpl_vars['categoryProduct']->value['link_rewrite'],$_smarty_tpl->tpl_vars['categoryProduct']->value['category'],$_smarty_tpl->tpl_vars['categoryProduct']->value['ean13']);?>
" title="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['categoryProduct']->value['name']);?>
">
...
" title="<?php echo smartyTranslate(array('s'=>'Download'),$_smarty_tpl);?>
"><?php echo smartyTranslate(array('s'=>'Download'),$_smarty_tpl);?>
</a>
								<?php }else{ ?>
									<span class="exclusive"><?php echo smartyTranslate(array('s'=>'Download'),$_smarty_tpl);?>
</span>
...
<?php }?>
<!--<div style="color:#989898; float:right; margin-right:4px; margin-top:50px;">Click here to view all details of your account<br />
