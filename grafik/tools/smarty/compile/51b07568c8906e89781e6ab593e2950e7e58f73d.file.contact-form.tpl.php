<?php /* Smarty version Smarty-3.0.7, created on 2012-10-14 01:56:46
         compiled from "/home/graf546/domains/grafikstock.com/public_html/grafik/themes/prestashop/contact-form.tpl" */ ?>
<?php /*%%SmartyHeaderCode:189858210507a0dce1c10e3-75403153%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '51b07568c8906e89781e6ab593e2950e7e58f73d' => 
    array (
      0 => '/home/graf546/domains/grafikstock.com/public_html/grafik/themes/prestashop/contact-form.tpl',
      1 => 1335412349,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '189858210507a0dce1c10e3-75403153',
  'function' => 
  array (
  ),
...
?>
					<?php if ($_smarty_tpl->tpl_vars['contact']->value['id_contact']==$_smarty_tpl->getVariable('customerThread')->value['id_contact']){?>
						<input type="text" class="text" id="contact_name" name="contact_name" value="<?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['contact']->value['name'],'htmlall','UTF-8');?>
" readonly="readonly" />
...
" class="desc_contact" style="display:none;">
			...
			<p class="text">
				...
				<?php if (isset($_smarty_tpl->getVariable('customerThread',null,true,false)->value['email'])){?>
					<input type="text" class="text" id="email" name="from" value="<?php echo $_smarty_tpl->getVariable('customerThread')->value['email'];?>
" readonly="readonly" />
				<?php }else{ ?>
					<input type="text" class="text" id="email" name="from" value="<?php echo $_smarty_tpl->getVariable('email')->value;?>
" />
				<?php }?>
			</p>
		<?php if (!$_smarty_tpl->getVariable('PS_CATALOG_MODE')->value){?>
			...
			<p class="text">
				...
				<?php }elseif(!isset($_smarty_tpl->getVariable('customerThread',null,true,false)->value['id_order'])&&!isset($_smarty_tpl->getVariable('isLogged',null,true,false)->value)){?>
					<input type="text" class="text" name="id_order" id="id_order" value="<?php if (isset($_smarty_tpl->getVariable('customerThread',null,true,false)->value['id_order'])&&$_smarty_tpl->getVariable('customerThread')->value['id_order']>0){?><?php echo intval($_smarty_tpl->getVariable('customerThread')->value['id_order']);?>
...
<?php }?><?php }?>" />
				<?php }elseif($_smarty_tpl->getVariable('customerThread')->value['id_order']>0){?>
					<input type="text" class="text" name="id_order" id="id_order" value="<?php echo intval($_smarty_tpl->getVariable('customerThread')->value['id_order']);?>
" readonly="readonly" />
				<?php }?>
			</p>
			<?php }?>
...
" readonly="readonly" />
		...
		<?php if ($_smarty_tpl->getVariable('fileupload')->value==1){?>
			...
			<label for="fileUpload"><?php echo smartyTranslate(array('s'=>'Attach File'),$_smarty_tpl);?>
				...
				<input type="file" class="text" name="fileUpload" id="fileUpload" />
			</p>
		<?php }?>
		<p class="textarea">
