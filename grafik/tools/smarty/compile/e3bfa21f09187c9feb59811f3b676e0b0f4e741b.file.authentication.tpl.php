<?php /* Smarty version Smarty-3.0.7, created on 2012-10-16 17:39:09
         compiled from "/home/graf546/domains/grafikstock.com/public_html/grafik/themes/prestashop/authentication.tpl" */ ?>
<?php /*%%SmartyHeaderCode:859619910507d8dad92fd51-23715078%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'e3bfa21f09187c9feb59811f3b676e0b0f4e741b' => 
    array (
      0 => '/home/graf546/domains/grafikstock.com/public_html/grafik/themes/prestashop/authentication.tpl',
      1 => 1335412347,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '859619910507d8dad92fd51-23715078',
  'function' => 
  array (
  ),
...
.</h4>
			<p class="text">
				...
				<input type="text" class="text" id="email_create" name="email_create" value="<?php if (isset($_POST['email_create'])){?><?php echo stripslashes(smarty_modifier_escape($_POST['email_create'],'htmlall','UTF-8'));?>
...
<?php }?>" class="account_input" />
			...
			<p class="text">
				...
				<input type="password" class="text" id="passwd" name="passwd" value="<?php if (isset($_POST['passwd'])){?><?php echo stripslashes(smarty_modifier_escape($_POST['passwd'],'htmlall','UTF-8'));?>
<?php }?>" class="account_input" />
			</p>
			<p class="submit">
				<?php if (isset($_smarty_tpl->getVariable('back',null,true,false)->value)){?><input type="hidden" class="hidden" name="back" value="<?php echo smarty_modifier_escape($_smarty_tpl->getVariable('back')->value,'htmlall','UTF-8');?>
