<?php /* Smarty version Smarty-3.0.7, created on 2012-09-19 21:38:26
         compiled from "/home/graf546/domains/grafikstock.com/public_html/grafik/themes/prestashop/address.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1328434756505a2d42037d63-71319206%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'c4c97da1afd6588f0554e845e7faca6443808cf7' => 
    array (
      0 => '/home/graf546/domains/grafikstock.com/public_html/grafik/themes/prestashop/address.tpl',
      1 => 1344460818,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1328434756505a2d42037d63-71319206',
  'function' => 
  array (
  ),
  'has_nocache_code' => false,
)); /*/%%SmartyHeaderCode%%*/?>
<?php if (!is_callable('smarty_function_counter')) include '/home/graf546/domains/grafikstock.com/public_html/grafik/tools/smarty/plugins/function.counter.php';
...
<?php }?><?php }?>" />
		...
		<p class="required text">
			...
			<input type="text" class="text" name="firstname" id="firstname" value="<?php if (isset($_POST['firstname'])){?><?php echo $_POST['firstname'];?>
...
<?php }?><?php }?>" />
		...
		<p class="required text">
			...
			<input type="text" class="text" id="address1" name="address1" value="<?php if (isset($_POST['address1'])){?><?php echo $_POST['address1'];?>
...
<?php }?><?php }?>" />
		...
		<p class="required text">
			...
			<input type="text" class="text" id="address2" name="address2" value="<?php if (isset($_POST['address2'])){?><?php echo $_POST['address2'];?>
...
<?php }?><?php }?>" />
		...
		<p class="required postcode text">
			...
			<input type="text" class="text" id="postcode" name="postcode" value="<?php if (isset($_POST['postcode'])){?><?php echo $_POST['postcode'];?>
...
" /></p>
		...
		<p class="textarea">
			...
			<textarea id="other" name="other" cols="44" rows="3"><?php if (isset($_POST['other'])){?><?php echo $_POST['other'];?>
...
<?php }?><?php }?></textarea>
 ...
 <sup style="color:red;">*</sup></p>
		<p class="text">
			...
			<input type="text" class="text" id="phone" name="phone" value="<?php if (isset($_POST['phone'])){?><?php echo $_POST['phone'];?>
...
<?php }?><?php }?>" />
		...
		<p class="text">
			...
			<input type="text" class="text" id="phone_mobile" name="phone_mobile" value="<?php if (isset($_POST['phone_mobile'])){?><?php echo $_POST['phone_mobile'];?>
...
<?php }?><?php }?>" />
		...
		<p class="required text" id="address_alias">
			...
			<input type="text" class="text" id="alias" name="alias" value="<?php if (isset($_POST['alias'])){?><?php echo $_POST['alias'];?>
