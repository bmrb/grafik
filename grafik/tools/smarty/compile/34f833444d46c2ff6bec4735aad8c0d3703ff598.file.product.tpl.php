<?php /* Smarty version Smarty-3.0.7, created on 2012-04-16 19:40:11
         compiled from "C:\wamp\www\grafik/themes/prestashop/product.tpl" */ ?>
<?php /*%%SmartyHeaderCode:45454f8c678ba3b683-35576537%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '34f833444d46c2ff6bec4735aad8c0d3703ff598' => 
    array (
      0 => 'C:\\wamp\\www\\grafik/themes/prestashop/product.tpl',
      1 => 1334568395,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '45454f8c678ba3b683-35576537',
  'function' => 
  array (
  ),
...
if (!is_callable('smarty_function_math')) include 'C:\wamp\www\grafik\tools\smarty\plugins\function.math.php';
if (!is_callable('smarty_function_counter')) include 'C:\wamp\www\grafik\tools\smarty\plugins\function.counter.php';
?>
...
" />
    ...
    <b><span style="font-family:Arial, Helvetica, sans-serif; font-weight:bold; font-size:13px; color:#666;">&nbsp;&nbsp;<?php echo smarty_modifier_escape($_smarty_tpl->getVariable('product')->value->name,'htmlall','UTF-8');?>
</span></b>
    
		<?php if ($_smarty_tpl->getVariable('product')->value->description_short||count($_smarty_tpl->getVariable('packItems')->value)>0){?>
		<div id="short_description_block" style="font-family:Arial, Helvetica, sans-serif; font-weight:normal; font-size:12px; color:#303235;">
			<?php if ($_smarty_tpl->getVariable('product')->value->description_short){?>
				<div id="short_description_content" class="rte align_justify" style="font-family:Arial, Helvetica, sans-serif; font-weight:normal; font-size:12px; color:#303235;"><?php echo $_smarty_tpl->getVariable('product')->value->description_short;?>
</div>
			<?php }?>

            <div>
        <b><span style="font-family:Arial, Helvetica, sans-serif; font-weight:bold; font-size:13px; color:#666;">Image ID:</b></span><span style="font-size:16px"><?php echo smarty_modifier_escape($_smarty_tpl->getVariable('product')->value->reference,'htmlall','UTF-8');?>
</span><br /><br />
       <b><span style="font-family:Arial, Helvetica, sans-serif; font-weight:bold; font-size:13px; color:#666;">Requires Credits:</span></b> <span style="font-size:16px"><?php echo $_smarty_tpl->getVariable('tokens')->value;?>
</span><br /><br />
<!-- module productpagetags -->
<?php if (count($_smarty_tpl->getVariable('tags')->value)>0){?>
     <div id="productpage_tag" style="font-family:Arial, Helvetica, sans-serif; font-weight:bold; font-size:13px; color:#666;"> Keywords:<br />
...
" style="font-family:Arial, Helvetica, sans-serif; font-weight:normal; font-size:12px; color:#303235; text-decoration:none"><?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['tag']->value,'htmlall','UTF-8');?>
</a>,&nbsp;
        <?php }} ?>
        </div>
<?php }?>
...
?>
<?php if ($_smarty_tpl->getVariable('smarty')->value['foreach']['categoryProduct']['index']==6){?>
    <?php break 1?>
<?php }?> 
			<li class="ajax_block_product" style="width:120px">
