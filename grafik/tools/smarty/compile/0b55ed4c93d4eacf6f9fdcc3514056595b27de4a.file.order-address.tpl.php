<?php /* Smarty version Smarty-3.0.7, created on 2012-10-09 22:46:59
         compiled from "/home/graf546/domains/grafikstock.com/public_html/grafik/themes/prestashop/order-address.tpl" */ ?>
<?php /*%%SmartyHeaderCode:133006870850749b537d94b1-48879065%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '0b55ed4c93d4eacf6f9fdcc3514056595b27de4a' => 
    array (
      0 => '/home/graf546/domains/grafikstock.com/public_html/grafik/themes/prestashop/order-address.tpl',
      1 => 1335412353,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '133006870850749b537d94b1-48879065',
  'function' => 
  array (
  ),
...
<?php }?>
	...
	outline: none" name="id_address_delivery" id="id_address_delivery" onchange="updateAddressesDisplay();<?php if ($_smarty_tpl->getVariable('opc')->value){?>updateAddressSelection();<?php }?>">
...
if ($_smarty_tpl->_count($_from) > 0){
 ...
 $_smarty_tpl->tpl_vars['k']->value = $_smarty_tpl->tpl_vars['address']->key;
?>
				<option style="	margin-left: 0em;
        margin-top:2px;
        font-weight:normal;
        height:19px;
	font-size: 12px;
	font-family: Verdana, Arial, Helvetica, Sans-Serif;
	outline: none" value="<?php echo intval($_smarty_tpl->tpl_vars['address']->value['id_address']);?>
